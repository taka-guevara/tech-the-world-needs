...
className="m-2 border border-transparent focus:outline-none focus:ring-2 focus:ring-green-600 focus:border-transparent py-2 px-4 font-semibold rounded-lg shadow-md text-black" />
          <input type="button" value="検索" onClick={() => searchTech()} className="m-2 bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50 py-2 px-4 font-semibold rounded-lg shadow-md text-white cursor-pointer"/>
        </form>
      </div>
